...
INSERT INTO `tasks` (`start_date`, `end_date`, `task_name`, `file_path`, `deadline`, `author_id`, `project_id`) VALUES
  ('2018-05-01 12:00:00', NULL, 'Собеседование в IT компании', NULL, '2018-06-01 12:00:00', 1, 2),
  ('2018-05-01 12:00:00', NULL, 'Выполнить тестовое задание', NULL, '2018-05-25 12:00:00', 1, 2),
  ('2018-04-20 12:00:00', '2018-04-21 12:00:00', 'Сделать задание первого раздела', NULL, '2018-04-21 12:00:00', 2, 1),
  ('2018-04-20 12:00:00', NULL, 'Встреча с другом', NULL, '2018-04-22 12:00:00', 1, NULL),
  ('2018-04-22 12:00:00', NULL, 'Купить корм для кота', NULL, NULL, 2, 3),
  ('2018-05-08 12:00:00', NULL, 'Заказать пиццу', NULL, NULL, 2, 3);
